    ...
    onFormSubmit(form) {
        ...
        this.ref.orderByChild('roomname').equalTo(room.roomname).once('value', (snapshot) => {
            if (snapshot.exists()) {
                ...
                const newRoom = firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('rooms/').push();
                newRoom.set(room);
...
AddroomComponent.ɵfac = function AddroomComponent_Factory(t) { return new (t || AddroomComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_4__["MatSnackBar"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddroomComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_4__["MatSnackBar"] }]; }, null); })();
...
/* harmony import */ var _addroom_addroom_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addroom/addroom.component */ "./src/app/addroom/addroom.component.ts");
/* harmony import */ var _chatroom_chatroom_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chatroom/chatroom.component */ "./src/app/chatroom/chatroom.component.ts");
...
const routes = [
    ...
    { path: 'roomlist', component: _roomlist_roomlist_component__WEBPACK_IMPORTED_MODULE_5__["RoomlistComponent"] },
    { path: 'addroom', component: _addroom_addroom_component__WEBPACK_IMPORTED_MODULE_2__["AddroomComponent"] },
    { path: 'chatroom/:roomname', component: _chatroom_chatroom_component__WEBPACK_IMPORTED_MODULE_3__["ChatroomComponent"] },
    { path: '',
        redirectTo: '/login',
        pathMatch: 'full'
    }
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 2, vars: 0, consts: [[1, "container"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _addroom_addroom_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./addroom/addroom.component */ "./src/app/addroom/addroom.component.ts");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
/* harmony import */ var _chatroom_chatroom_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./chatroom/chatroom.component */ "./src/app/chatroom/chatroom.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./login/login.component */ "./src/app/login/login.component.ts");
/* harmony import */ var _roomlist_roomlist_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./roomlist/roomlist.component */ "./src/app/roomlist/roomlist.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_16__["AppComponent"],
        ...
        _roomlist_roomlist_component__WEBPACK_IMPORTED_MODULE_19__["RoomlistComponent"],
        _addroom_addroom_component__WEBPACK_IMPORTED_MODULE_14__["AddroomComponent"],
        _chatroom_chatroom_component__WEBPACK_IMPORTED_MODULE_17__["ChatroomComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_12__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_15__["AppRoutingModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_13__["BrowserAnimationsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _roomlist_roomlist_component__WEBPACK_IMPORTED_MODULE_19__["RoomlistComponent"],
                    _addroom_addroom_component__WEBPACK_IMPORTED_MODULE_14__["AddroomComponent"],
                    _chatroom_chatroom_component__WEBPACK_IMPORTED_MODULE_17__["ChatroomComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_12__["BrowserModule"],
                    _app_routing_module__WEBPACK_IMPORTED_MODULE_15__["AppRoutingModule"],
...
function ChatroomComponent_div_12_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](3, 2, chat_r5.date, "yyyy/MM/dd HH:mm:ss"), "\u00A0");
...
class ChatroomComponent {
    constructor(router, route, formBuilder, datepipe) {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chats/').on('value', resp => {
            this.chats = [];
            this.chats = snapshotToArray(resp);
            setTimeout(() => this.scrolltop = this.chatcontent.nativeElement.scrollHeight, 500);
        });
        firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('roomusers/').orderByChild('roomname').equalTo(this.roomname).on('value', (resp2) => {
    ...
    onFormSubmit(form) {
        ...
        chat.type = 'message';
        const newMessage = firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chats/').push();
        newMessage.set(chat);
        this.chatForm = this.formBuilder.group({
            message: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]
        });
    ...
    exitChat() {
        ...
        const newMessage = firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chats/').push();
        newMessage.set(chat);
        firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('roomusers/').orderByChild('roomname').equalTo(this.roomname).on('value', (resp) => {
            let roomuser = [];
            roomuser = snapshotToArray(resp);
            const user = roomuser.find(x => x.nickname === this.nickname);
            if (user !== undefined) {
                const userRef = firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('roomusers/' + user.key);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ChatroomComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _angular_common__WEBPACK_IMPORTED_MODULE_4__["DatePipe"] }]; }, { chatcontent: [{
    ...
    onFormSubmit(form) {
        ...
        this.ref.orderByChild('nickname').equalTo(login.nickname).once('value', snapshot => {
            if (snapshot.exists()) {
                ...
                const newUser = firebase_app__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('users/').push();
                newUser.set(login);
                localStorage.setItem('nickname', login.nickname);
                this.router.navigate(['/roomlist']);
            }
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 14, vars: 4, consts: [[1, "container"], [1, "example-form", 3, "formGroup", "ngSubmit"], [1, "example-full-width"], ["matInput", "", "placeholder", "Enter your nickname", "formControlName", "nickname", 3, "errorStateMatcher"], [4, "ngIf"], [1, "button-row"], ["type", "submit", "mat-fab", "", "color", "primary", 3, "disabled"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "form", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function LoginComponent_Template_form_ngSubmit_1_listener() { return ctx.onFormSubmit(ctx.loginForm.value); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "h2");
...
class RoomlistComponent {
    constructor(route, router, datepipe) {
        ...
        this.nickname = localStorage.getItem('nickname');
        firebase_app__WEBPACK_IMPORTED_MODULE_1__["database"]().ref('rooms/').on('value', resp => {
            this.rooms = [];
    ...
    enterChatRoom(roomname) {
        ...
        chat.type = 'join';
        const newMessage = firebase_app__WEBPACK_IMPORTED_MODULE_1__["database"]().ref('chats/').push();
        newMessage.set(chat);
        firebase_app__WEBPACK_IMPORTED_MODULE_1__["database"]().ref('roomusers/').orderByChild('roomname').equalTo(roomname).on('value', (resp) => {
            let roomuser = [];
            roomuser = snapshotToArray(resp);
            const user = roomuser.find(x => x.nickname === this.nickname);
            if (user !== undefined) {
                const userRef = firebase_app__WEBPACK_IMPORTED_MODULE_1__["database"]().ref('roomusers/' + user.key);
                ...
                const newRoomUser = firebase_app__WEBPACK_IMPORTED_MODULE_1__["database"]().ref('roomusers/').push();
...
RoomlistComponent.ɵfac = function RoomlistComponent_Factory(t) { return new (t || RoomlistComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_4__["DatePipe"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RoomlistComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _angular_common__WEBPACK_IMPORTED_MODULE_4__["DatePipe"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! D:\MyWeb\SimpleChat\SimpleChat\src\main.ts */"./src/main.ts");
